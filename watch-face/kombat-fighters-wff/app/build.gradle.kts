...
android {
    namespace = "com.bakerapps.kombatfighters"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.bakerapps.kombatfighters"
        minSdk = 34
        targetSdk = 35
        versionCode = 4
        versionName = "1.0.1"
    ...
    signingConfigs {
        create("release") {
            storeFile = file("../kombat-fighters-release.jks")
            storePassword = "KombatF1ghters@2026!"
            keyAlias = "kombatfighters"
            keyPassword = "KombatF1ghters@2026!"
        }
    }
